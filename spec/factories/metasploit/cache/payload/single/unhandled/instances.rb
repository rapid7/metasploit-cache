FactoryGirl.define do
  factory :metasploit_cache_payload_single_unhandled_instance,
          class: Metasploit::Cache::Payload::Single::Unhandled::Instance do
    description { generate :metasploit_cache_payload_single_unhandled_instance_description }
    name { generate :metasploit_cache_payload_single_unhandled_instance_name }
    privileged { generate :metasploit_cache_payload_single_unhandled_instance_privileged }
    ...
    factory :full_metasploit_cache_payload_single_unhandled_instance,
            traits: [
  ...
  sequence(:metasploit_cache_payload_single_unhandled_instance_description) { |n|
    "Metasploit::Cache::Payload::Single::Unhandled::Instance#description #{n}"
  }

  sequence(:metasploit_cache_payload_single_unhandled_instance_name) { |n|
    "Metasploit::Cache::Payload::Single::Unhandled::Instance#name #{n}"
  }

  sequence :metasploit_cache_payload_single_unhandled_instance_privileged, Metasploit::Cache::Spec.sample_stream([false, true])

  #
  # Traits
  #

  trait :metasploit_cache_payload_single_unhandled_instance_payload_single_unhandled_class_ancestor_contents do
    transient do
    ...
    after(:build) do |payload_single_unhandled_instance, evaluator|
      payload_single_unhandled_class = payload_single_unhandled_instance.payload_single_unhandled_class

      if payload_single_unhandled_class.nil?
        raise ArgumentError,
              "#{payload_single_unhandled_instance.class}#payload_single_unhandled_class is `nil` and it can't be used to look up " \
      ...
      cell = Metasploit::Cache::Payload::Single::Unhandled::Instance::PayloadSingleUnhandledClass::AncestorCell.(
