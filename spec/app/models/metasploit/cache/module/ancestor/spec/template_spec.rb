...
RSpec.describe Metasploit::Cache::Module::Ancestor::Spec::Template do
  subject(:template) do
    described_class.new(
  ...
  context '#metasploit_module_relative_name' do
    ...
    it 'uses FactoryGirl.generate' do
      ...
      expect(FactoryGirl).to receive(:generate).with(:metasploit_cache_module_ancestor_metasploit_module_relative_name).and_call_original
