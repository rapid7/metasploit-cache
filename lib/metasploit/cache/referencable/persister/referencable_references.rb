...
# instances.
module Metasploit::Cache::Referencable::Persister::ReferencableReferences
  #
  # Module Methods
  #
  ...
  # @param logger (see Metasploit::Cache::Reference::Persister.new_by_attributes_proc)
  ...
  def self.build_added(destination:, destination_attributes_set:, logger:, source_attributes_set:)
    cached_added_attributes_set = Metasploit::Cache::Persister::AttributeSet.added(
    ...
    cached_reference_by_attributes = Metasploit::Cache::Reference::Persister.by_attributes(
  ...
  def self.referencable_reference_by_attributes(destination)
    if destination.new_record?
      ...
      destination.referencable_references.each_with_object({}) do |referencable_reference, hash|
        ...
        attributes = Metasploit::Cache::Reference::Persister.attributes(reference)
