...
module Metasploit::Cache::Spec
  ...
  # Defines a shared examples for a `Module` under the {Metasploit::Cache} namespace.  This `Module` is assumed to
  ...
  # for all the {Metasploit::Cache} mixin `Modules`:
  #
  ...
  #   # defined shared example's name will be 'Metasploit::Cache::Module::Ancestor', but you only need to give the
  #   # name relative to 'Metasploit::Cache'.
  #   Metasploit::Cache::Spec.shared_examples_for 'Module::Ancestor' do
  ...
  #   describe Metasploit::Cache::Module::Ancestor do
  #     it_should_behave_like 'Metasploit::Cache::Module::Ancestor',
  #                           namespace_name: 'Dummy'
  #   end
  #
  # @param relative_name [String] name relative to 'Metasploit::Cache' prefix.  For example, to declare
  #   'Metasploit::Cache::Module::Ancestor' shared example, `relative_name` would be just 'Module::Ancestor'.
  # @yield Body of shared examples.
  # @yieldreturn [void]
  # @return [void]
  def self.shared_examples_for(relative_name, &block)
    fully_qualified_name = "Metasploit::Cache::#{relative_name}"
