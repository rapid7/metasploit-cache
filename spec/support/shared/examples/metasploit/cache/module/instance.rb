Metasploit::Cache::Spec.shared_examples_for 'Module::Instance' do
  #
  # Classes
  #
  ...
  context '#allows?' do
    ...
    context 'with valid #module_type' do
      ...
      it 'should call allows? on class' do
        ...
        expect(base_class).to receive(:allows?).with(
            hash_including(
                attribute: attribute,
                module_type: module_type
            )
  ...
  context '#dynamic_length_validation_options' do
    ...
    context 'with valid #module_type' do
      ...
      it 'should call dynamic_length_validation_options on class' do
        expect(base_class).to receive(:dynamic_length_validation_options).with(
            hash_including(
                attribute: attribute,
                module_type: module_type
            )
  ...
  context '#stanced?' do
    ...
    context 'with valid #module_type' do
      ...
      it 'should call stanced? on class' do
        expect(base_class).to receive(:stanced?).with(module_type)
