Metasploit::Cache::Spec.shared_examples_for 'Authority' do
  ...
  context 'factories' do
    ...
    context full_authority_factory do
      ...
      it 'has a summary' do
        expect(send(full_authority_factory).send(:summary)).not_to be_nil
      end

      it 'has a url' do
        expect(send(full_authority_factory).send(:url)).not_to be_nil
      end
    end
    ...
    context obsolete_authority_factory do
      ...
      it 'is obsolete' do
        expect(send(obsolete_authority_factory).send(:obsolete)).to eq(true)
      end
    end
  end
