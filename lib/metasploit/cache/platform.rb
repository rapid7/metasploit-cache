...
module Metasploit::Cache::Platform
  ...
  included do
    ...
    validates :fully_qualified_name,
              inclusion: {
                  in: Metasploit::Cache::Platform.fully_qualified_name_set
              }
  ...
  module ClassMethods
    # Set of valid {Metasploit::Cache::Platform#fully_qualified_name}.
    #
    # @return [Set<String>]
    def fully_qualified_name_set
      Metasploit::Cache::Platform.fully_qualified_name_set
    end
  end
  ...
  # @note Not defined in `ClassMethods` because consumers should always refer back to {Metasploit::Cache::Platform}
  #   when seeding.
  #
