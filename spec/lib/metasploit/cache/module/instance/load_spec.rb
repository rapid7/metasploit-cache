    ...
    context 'metasploit-framework', :content do
      ...
      module_path_real_paths.each do |module_path_real_path|
        ...
        context module_path_relative_pathname.to_s do
          ...
          shared_examples_for 'loads payload single handled Metasploit Module instances' do |module_path_real_pathname|
            ...
            context relative_path_prefix, :payload_single do
              ...
              rule.find do |real_path|
                ...
                context display_path do
                  ...
                  let(:payload_single_handled_instance) {
                    payload_single_handled_class.build_payload_single_handled_instance
                  }
                  ...
                  it 'loads Metasploit::Cache::Payload::Single::Handled::Instance' do
                    ...
                    expect(payload_single_handled_instance).to be_persisted
                  end
                end
              end
            end
          ...
          # @see spec/exe/metasploit_cache_spec.rb for testing of encoders
          ...
          # @see spec/exe/metasploit_cache_spec.rb for testing of nops

          include_examples 'loads payload single handled Metasploit Module instances',
                           module_path_real_pathname
          ...
          it_should_behave_like 'loads only these stage and stager combinations',
                                {
                                    'android/meterpreter' => android_stagers,
                                    'android/shell' => android_stagers,
                                    'bsdi/x86/shell' => %w{
                                        bsdi/x86/bind_tcp
                                    ...
                                    'java/meterpreter' => java_stagers,
                                    'java/shell' => java_stagers,
                                    'linux/armle/shell' => %w{
                                    ...
                                    'linux/x86/meterpreter' => linux_x86_stagers,
                                    'linux/x86/shell' => linux_x86_stagers,
                                    'netware/shell' => %w{
                                        netware/reverse_tcp
                                    },
                                    'osx/armle/execute' => osx_armle_stagers,
                                    'osx/armle/shell' => osx_armle_stagers,
                                    'osx/ppc/shell' => %w{
                                        osx/ppc/bind_tcp
                                        osx/ppc/find_tag
                                        osx/ppc/reverse_tcp
                                    ...
                                    'osx/x86/bundleinject' => osx_x86_stagers,
                                    'osx/x86/isight' => osx_x86_stagers,
                                    'osx/x86/vforkshell' => osx_x86_stagers,
                                    'php/meterpreter' => %w{
                                        php/bind_tcp
                                        php/bind_tcp_ipv6
                                    ...
                                    'windows/dllinject' => windows_x86_stagers,
                                    'windows/meterpreter' => windows_x86_stagers,
                                    'windows/patchupdllinject' => windows_x86_stagers,
                                    'windows/patchupmeterpreter' => windows_x86_stagers,
                                    'windows/shell' => windows_x86_stagers,
                                    'windows/upexec' => windows_x86_stagers,
                                    'windows/vncinject' => windows_x86_stagers,
                                    'windows/x64/meterpreter' => windows_x86_64_stagers,
                                    'windows/x64/shell' => windows_x86_64_stagers,
                                    'windows/x64/vncinject' => windows_x86_64_stagers
                                }
