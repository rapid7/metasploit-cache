shared_examples_for 'Metasploit::Cache::Module::Instance validates dynamic length of' do |attribute, options={}|
  ...
  context attribute do
    context 'errors' do
      ...
      let(:error_key) do
        "metasploit.model.errors.models.metasploit/cache/module/instance.attributes.#{attribute}.#{error_type}"
      end
      ...
      context '#module_type' do
        Metasploit::Cache::Module::Type::ALL.each do |module_type|
