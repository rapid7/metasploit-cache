shared_examples_for 'search query with Metasploit::Cache::Search::Operator::Deprecated::Authority' do |options={}|
  ...
  context "with #{formatted_operator}" do
    ...
    context 'operations' do
      ...
      context 'authoritities.abbreviation' do
        ...
        context 'Metasploit::Cache::Search::Operation::Association#source_operation' do
          subject(:source_operation) {
            operation.source_operation
          }

          context 'Metasploit::Cache::Search::Operation::Base#value' do
            subject(:value) {
