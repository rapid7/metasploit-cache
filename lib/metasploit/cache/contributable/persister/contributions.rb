...
module Metasploit::Cache::Contributable::Persister::Contributions
  #
  # Module Methods
  #
  ...
  def self.build_added(destination:, destination_attributes_set:, source_attributes_set:)
    ...
    cached_author_by_name = Metasploit::Cache::Author::Persister.by_name(
    ...
    cached_email_address_by_full = Metasploit::Cache::EmailAddress::Persister.by_full(
  ...
  def self.mark_removed_for_destruction(contribution_by_attributes:, destination:, destination_attributes_set:, source_attributes_set:)
    cached_removed_attributes_set = Metasploit::Cache::Persister::AttributeSet.removed(
        destination: destination_attributes_set,
        source: source_attributes_set
    )
