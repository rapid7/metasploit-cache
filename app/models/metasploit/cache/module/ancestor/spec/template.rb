...
#
#   # update
#   module_ancestor.module_type = FactoryGirl.generate :metasploit_cache_module_type
#
...
class Metasploit::Cache::Module::Ancestor::Spec::Template < Metasploit::Cache::Spec::Template
  ...
  def metasploit_module_relative_name
    @metasploit_module_relative_name ||= FactoryGirl.generate :metasploit_cache_module_ancestor_metasploit_module_relative_name
  end
