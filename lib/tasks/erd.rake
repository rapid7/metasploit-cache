if defined? RailsERD
  namespace :erd do
    namespace :metasploit do
      namespace :cache do
        desc "Generates a pdf containing an Entity-Relationship Diagram for all Metasploit::Cache::Module models"
    ...
    desc "Generates a pdf containing an Entity-Relationship Diagram for all Metasploit::Cache models"
    task 'metasploit:cache' => :require do
      path = MetasploitDataModels::EntityRelationshipDiagram.create(
          :filename => 'mdm.erd',
