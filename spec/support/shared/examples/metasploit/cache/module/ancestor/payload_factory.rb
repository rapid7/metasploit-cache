shared_examples_for 'Metasploit::Cache::Module::Ancestor payload factory' do |options={}|
      ...
      unless should_have_handler_type.nil?
        ...
        if should_have_handler_type
          ...
          context 'handler_module' do
            ...
            it_should_behave_like 'Metasploit::Cache::Module::Handler'
            ...
            context 'handler_type' do
              ...
              it 'is different than Metasploit::Cache::Module::Ancestor#handler_type' do
