...
- [ ] Add an item to each category's list in the following format: `[#<PR>](https://github.com/rapid7/metasploit-cache/pull/<PR>) <consumer summary> - [@<github_user>](https://github.com/<github_user>)`
...
increment [`PATCH`](lib/metasploit/cache/version.rb).
...
1. To remain pre-1..0.0, then increment [`MINOR`](lib/metasploit/cache/version.rb) and reset [`PATCH`](lib/metasploit/cache/version.rb) to `0`.
2. To advance to 1.0.0, increment [`MAJOR`](lib/metasploit/cache/version.rb) and reset [`MINOR`](lib/metasploit/cache/version.rb and [`PATCH`](lib/metasploit/cache/version.rb) to `0`.
