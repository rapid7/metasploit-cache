...
# {Metasploit::Cache::Module::Instance#module_class #module_class's} {Metasploit::Cache::Module::Class#ancestors} to
# disk.
#
...
class Metasploit::Cache::Module::Instance::Spec::Template < Metasploit::Model::Base
  ...
  #   The {Metasploit::Cache::Module::Instance} whose {Metasploit::Cache::Module::Instance#module_class} needs to be
  ...
  # Template for {#module_instance} {Metasploit::Cache::Module::Instance#module_class} with the addition of
  # {#module_instance} to the {Metasploit::Cache::Spec::Template#locals} and adding 'module/instances' to the front of
  # the {Metasploit::Cache::Spec::Template#search_pathnames}.
  #
  # @return [Metasploit::Cache::Module::Class::Spec::Template] if {#module_instance} present.
  # @return [nil] if {#module_instance} is `nil`.
  def class_template
    unless instance_variable_defined? :@class_template
      if module_instance
        class_template = Metasploit::Cache::Module::Class::Spec::Template.new(
