# Adds {#persister_by_source} to Metasploit Module.
module Metasploit::Cache::Cacheable
  # Persister by the source of the cached metadata.
  #
  # # Non-payload
  #
  ...
  # {#persister_by_source} will only contain the one source:
  # * `:ancestor` - metadata gathered from the {Metasploit::Cache::Module::Ancestor::Load}
  #
  # ## Ruby Class for single payloads
  #
  # The subclass of the payload base class, `Msf::Payload`, with the
  # {Metasploit::Cache::Payload::Single::Ancestor#real_pathname} `Module` mixed in, will contain the persister from two
  # sources:
  # * `:class` - metadata gathered from the {Metasploit::Cache::Module::Class::Load} from `Class` constants or methods.
  # * `:instance` - metadata gathered from the {Metasploit::Cache::Module::Instance::Load} from the `#initialize` Hash.
  #
  ...
  #
  # The subclass of the payload base class, `Msf::Payload`, with the
  # {Metasploit::Cache::Payload::Stage::Ancestor#real_pathname} `Module` mixed in, will contain the persister from two
  # sources:
  # * `:class` - metadata gathered from the {Metasploit::Cache::Module::Class::Load} from `Class` constants or methods.
  # * `:instance` - metadata gathered from the {Metasploit::Cache::Module::Instance::Load} from the `#initialize` Hash.
  #
  ...
  #
  # The subclass of the payload base class, `Msf::Payload`, with the
  # {Metasploit::Cache::Payload::Stager::Ancestor#real_pathname} `Module` mixed in, will contain the persister from two
  # sources:
  # * `:class` - metadata gathered from the {Metasploit::Cache::Module::Class::Load} from `Class` constants or methods.
  # * `:instance` - metadata gathered from the {Metasploit::Cache::Module::Instance::Load} from the `#initialize` Hash.
  #
  ...
  # will contain the persister from two sources:
  # * `:class` - metadata gathered from the {Metasploit::Cache::Module::Class::Load} from `Class` constants or methods.
  # * `:instance` - metadata gathered from the {Metasploit::Cache::Module::Instance::Load} from the `#initialize` Hash.
  def persister_by_source
    @persister_by_source ||= {}
  end
end