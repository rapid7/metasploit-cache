...
ActiveRecord::Schema.define(version: 20150526204451) do
  ...
  add_index "mc_module_platforms", ["module_instance_id", "platform_id"], name: "index_mc_module_platforms_on_module_instance_id_and_platform_id", unique: true, using: :btree
